...
! function(e) {
    ...
    var n, t, i, s = 0,
        ...
        a = (l.cleanData = (n = l.cleanData, function(e) {
            ...
            _createWidget: function(e, t) {
                t = l(t || this.defaultElement || this)[0], this.element = l(t), this.uuid = s++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = l(), this.hoverable = l(), this.focusable = l(), this.classesElementLookup = {}, t !== this && (l.data(t, this.widgetFullName, this), this._on(!0, this.element, {
                    remove: function(e) {
        ...
        }), l.widget, l.expr.pseudos || (l.expr.pseudos = l.expr[":"]), l.uniqueSort || (l.uniqueSort = l.unique), l.escapeSelector || (t = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, i = function(e, t) {
            ...
            TAB: 9,
            UP: 38
        }, l.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()), !1);
    l(document).on("mouseup", function() {
        ...
        _mouseDown: function(e) {
            var t, i, s;
            if (!a) return this._mouseMoved = !1, this._mouseStarted && this._mouseUp(e), i = 1 === (this._mouseDownEvent = e).which, s = !("string" != typeof(t = this).options.cancel || !e.target.nodeName) && l(e.target).closest(this.options.cancel).length, i && !s && this._mouseCapture(e) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                t.mouseDelayMet = !0
            ...
            keydown: function(e) {
                ...
                switch (e.keyCode) {
                    ...
                    case l.ui.keyCode.LEFT:
                        if (e.preventDefault(), this._keySliding || (this._keySliding = !0, this._addClass(l(e.target), null, "ui-state-active"), !1 !== this._start(e, n))) break;
                        return
                }
